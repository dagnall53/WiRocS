...
void Status(){
  SetFont(1,99);OLED_5_line_display(1,"Setting up WiFi","","","","");
  SetFont(2,99);OLED_5_line_display(2,"Setting up WiFi","","","","");
  ...
  OLED_5_line_display(1,"Connecting to",wifiSSID.c_str(),"","","");OLED_5_line_display(2,"Connecting to",wifiSSID.c_str(),"","","");
  ...
  SetFont(1,99); OLED_5_line_display(1,"Connected to",wifiSSID.c_str(),"","Connecting to MQQT","");
  SetFont(2,99); OLED_5_line_display(2,"Connected to",wifiSSID.c_str(),"","","");
...
//------------------
 ...
 /////FTP Setup, ensure SPIFFS is started before ftp;  /////////
  ...
  delay(10);
  LookForOLEDs(); // test again, sets up any displays found (again) after Audio!! has potentially overwrittene things audio sets for LRC
  SetFont(1,99);
...
void loop() {
  ...
  if (LoopTimer >= lastsec ) {//sign of life flash 
    ...
    //DebugSprintfMsgSend(sprintf ( DebugMsg, "Clk :%d :%d :%d :%d ",ClockSettings[1],ClockSettings[2],ClockSettings[3],ClockSettings[4]));
